...
```shell
rm -fdr $HOME/repos && git clone --depth 1 --single-branch --recurse-submodules --shallow-submodules https://github.com/jjmc89-bot/jjmc89-bot-toolforge $HOME/repos && toolforge jobs run setup-venvs --command $HOME/repos/bin/setup-venvs --image python3.13 --wait
```
